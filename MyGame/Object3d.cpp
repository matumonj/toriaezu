...
Object3d* Object3d::Create(DirectXCommon* dxcomn, DebugCamera* camera)
{
	// 3Dオブジェクトのインスタンスを生成
...
bool Object3d::Initialize(DirectXCommon* dxcomn, DebugCamera* camera)
{
	// nullptrチェック
	assert(device);
...
void Object3d::Update(XMFLOAT4 color, DirectXCommon* dxcomn, DebugCamera* camera)
{
	HRESULT result;
